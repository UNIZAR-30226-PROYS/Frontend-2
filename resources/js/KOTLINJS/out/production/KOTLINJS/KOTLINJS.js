...
=======
  ...
  function main(args) {
    println(ensureNotNull(obtainUserDataServer('abelfff')).pictureLocationUri);
>>>>>>> backend
  }
...
<<<<<<< HEAD
        var album = Album_init(json.album.id, json.album.title, ensureNotNull(obtainUserDataServerFromID_0(json.album.user_id, null)), new Date(), getAlbumCoverPath(json.album.id), songs);
=======
  ...
  function obtainSongFromID(id, album) {
    ...
    if (Kotlin.primitiveCompareTo(req.status, 200) === 0) {
      ...
      if (equals(json.error, 'ok')) {
        if (album) {
<<<<<<< HEAD
          return Song_init(json.song.id, json.song.title, json.song.country, getSongLocationPath(json.song.id), L0, ensureNotNull(obtainAlbumFromID(json.song.album_id)), '', getSongLyricsPath(json.song.id));
        }
         else {
          return Song_init_1(json.song.id, json.song.title, json.song.country, getSongLocationPath(json.song.id), 0, null, '', getSongLyricsPath(json.song.id));
=======
...
<<<<<<< HEAD
      var user = User_init_3(json.profile.nick, json.profile.user, getUserProfilePicturePath(json.profile.bio), json.profile.verified, ensureNotNull(json.profile.mail), json.profile.bio, userDate);
=======
      var user = User_init_1(json.profile.nick, json.profile.user, getUserProfilePicturePath(json.profile.nick), json.profile.verified, ensureNotNull(json.profile.mail), json.profile.bio, userDate);
>>>>>>> backend
...
<<<<<<< HEAD
        return Playlist_init(id, json.title, ensureNotNull(obtainUserDataServerFromID_0(json.author, null)), getPlaylistCoverPath(id), songs, users);
=======
...
<<<<<<< HEAD
  ...
  function uploadSongServer(username, sessionToken, song) {
    ...
    if (song.album == null) {
      ...
      data = createForm(mapOf_0([to('token', sessionToken), to('title', song.name), to('albumID', ensureNotNull(song.album).id.toString()), to('country', song.country)]));
    }
    req.send(data);
    if (Kotlin.primitiveCompareTo(req.status, 200) === 0) {
      println(req.responseText);
...
<<<<<<< HEAD
  ...
  function doUpdateAccountServer(user, sessionToken) {
    ...
    update += 'username:' + username + ',mail:' + toString(user.email) + ',bio:' + toString(user.biography) + ',birth_date:' + toString(user.birthDate) + '}}';
    println('deleteSongServer');
    var req = new XMLHttpRequest();
  ...
  function Album() {
    ...
    this.name = '';
    this.creator = null;
    this.releaseDate = new Date(2018, 6);
    this.artLocationUri = null;
...
<<<<<<< HEAD
  function Album_init(id, name, creator, releaseDate, artLocationUri, content, $this) {
    $this = $this || Object.create(Album.prototype);
    Album.call($this);
    $this.id = id;
    $this.name = name;
    $this.creator = creator;
  ...
  function Album_init_0(id, name, creator, artLocationUri, $this) {
    $this = $this || Object.create(Album.prototype);
    Album.call($this);
    $this.id = id;
    $this.name = name;
...
>>>>>>> backend
  ...
  function Playlist_init(id, name, creator, artLocationUri, content, followed, $this) {
    $this = $this || Object.create(Playlist.prototype);
    Playlist.call($this);
    $this.id = id;
    $this.name = name;
    $this.creator = creator;
  ...
  function Playlist_init_0(id, name, creator, artLocationUri, $this) {
    $this = $this || Object.create(Playlist.prototype);
    Playlist.call($this);
    $this.id = id;
    $this.name = name;
...
<<<<<<< HEAD
  function Song_init(id, name, country, locationUri, duration, album, genere, lyrics, $this) {
    $this = $this || Object.create(Song.prototype);
    Song.call($this);
    $this.id = id;
    $this.name = name;
    $this.country = country;
  ...
  function Song_init_0(album, id, name, duration, locationUri, lyricsPath, genere, country, $this) {
    $this = $this || Object.create(Song.prototype);
    Song.call($this);
    return $this;
  }
  function Song_init_1(id, title, country, songLocationPath, i, nothing, s, songLyricsPath, $this) {
    $this = $this || Object.create(Song.prototype);
    Song.call($this);
    $this.id = id;
    $this.name = title;
...
>>>>>>> backend
  ...
  function User_init_3(nick, user, userProfilePicturePath, verified, mail, bio, userDate, $this) {
    $this = $this || Object.create(User.prototype);
    User.call($this);
    $this.name = nick;
    $this.username = user;
...
<<<<<<< HEAD
    ...
    var album1 = Album_init(L1, 'Jazz', autor1, new Date(2018, 3, 22), 'http://storage.googleapis.com/automotive-media/album_art.jpg', ArrayList_init());
    var album2 = Album_init(L2, 'Blues', autor2, new Date(2017, 6, 27), 'http://storage.googleapis.com/automotive-media/album_art_2.jpg', ArrayList_init());
    var cancion1 = Song_init_0(album1, 1, 'Jazz in Paris', L103000, 'http://storage.googleapis.com/automotive-media/Jazz_In_Paris.mp3', '', '', '');
    var cancion2 = Song_init_0(album2, 2, 'The Messenger', L132000, 'http://storage.googleapis.com/automotive-media/The_Messenger.mp3', '', '', '');
    var list1 = ArrayList_init();
    list1.add_11rb$(cancion1);
    list1.add_11rb$(cancion2);
    var list2 = ArrayList_init();
    list2.add_11rb$(cancion1);
    var playlist1 = Playlist_init(L1, 'dfsdfdsfd', autor1, 'http://storage.googleapis.com/automotive-media/album_art_2.jpg', list1, ArrayList_init());
    var playlist2 = Playlist_init(L2, 'dfsdfdsfd', autor1, 'http://storage.googleapis.com/automotive-media/album_art_2.jpg', list2, ArrayList_init());
...
=======
  Object.defineProperty(package$apis, 'localhost', {
    get: function () {
      return localhost;
    },
    set: function (value) {
  ...
  package$apis.uploadFile_puj7f4$ = uploadFile;
  package$apis.deleteFile_61zpoe$ = deleteFile;
>>>>>>> backend
...
>>>>>>> backend
  ...
  package$models.Album_init_wm91jm$ = Album_init;
  package$models.Album_init_aetceo$ = Album_init_0;
  package$models.Album = Album;
  package$models.Playlist_init_ylc0oi$ = Playlist_init;
  package$models.Playlist_init_aetceo$ = Playlist_init_0;
  package$models.Playlist = Playlist;
  package$models.Recommendation = Recommendation;
  package$models.Song_init_jsezr5$ = Song_init;
  package$models.Song_init_4zn6bq$ = Song_init_0;
  package$models.Song_init_optps6$ = Song_init_1;
...
<<<<<<< HEAD
  ...
  package$models.User_init_jilh9y$ = User_init_3;
=======
