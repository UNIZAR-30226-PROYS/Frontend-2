...
var KOTLINJS = function (_, Kotlin) {
  ...
  function ServerEmulator() {
    ...
    var autor2 = User_init_1('Silent', 'Silent', 'Partner', '/resources/imgs/artistasap.jpeg');
    ...
    var $receiver = this.artistasSeguidos;
    var key = ensureNotNull(autor1.username);
    var value = ArrayList_init();
    $receiver.put_xwzc9p$(key, value);
    ensureNotNull(this.artistasSeguidos.get_11rb$(ensureNotNull(autor1.username))).add_11rb$(autor2);
    ensureNotNull(this.artistasSeguidos.get_11rb$(ensureNotNull(autor1.username))).add_11rb$(autor3);
    ensureNotNull(this.artistasSeguidos.get_11rb$(ensureNotNull(autor1.username))).add_11rb$(autor4);
    ...
    var playlist3 = new Playlist(L3, 'Playlist User', autor1, '/resources/imgs/albumasap.jpeg', this.songList2);
    var $receiver_0 = this.userList;
    var key_0 = ensureNotNull(autor1.username);
    $receiver_0.put_xwzc9p$(key_0, autor1);
    var $receiver_1 = this.userList;
    var key_1 = ensureNotNull(autor2.username);
    $receiver_1.put_xwzc9p$(key_1, autor2);
    var $receiver_2 = this.userList;
    var key_2 = ensureNotNull(autor3.username);
    $receiver_2.put_xwzc9p$(key_2, autor3);
    var $receiver_3 = this.songList;
    var key_3 = cancion1.id;
    $receiver_3.put_xwzc9p$(key_3, cancion1);
    var $receiver_4 = this.songList;
    var key_4 = cancion2.id;
    $receiver_4.put_xwzc9p$(key_4, cancion2);
    var $receiver_5 = this.playlistList;
    var key_5 = playlist1.id;
    $receiver_5.put_xwzc9p$(key_5, playlist1);
    var $receiver_6 = this.playlistList;
    var key_6 = playlist2.id;
    $receiver_6.put_xwzc9p$(key_6, playlist2);
    var $receiver_7 = this.playlistList;
    var key_7 = playlist3.id;
    $receiver_7.put_xwzc9p$(key_7, playlist3);
    var $receiver_8 = this.artistasSeguidos;
    var key_8 = ensureNotNull(autor3.username);
    var value_0 = ArrayList_init();
    $receiver_8.put_xwzc9p$(key_8, value_0);
    ...
    var $receiver_9 = this.cancionesFavoritas;
    var key_9 = ensureNotNull(autor3.username);
    var value_1 = ArrayList_init();
    $receiver_9.put_xwzc9p$(key_9, value_1);
    ...
    var $receiver_10 = this.playlistSeguidos;
    var key_10 = ensureNotNull(autor3.username);
    var value_2 = ArrayList_init();
    $receiver_10.put_xwzc9p$(key_10, value_2);
    ...
    var $receiver_11 = this.recomendaciones;
    var key_11 = ensureNotNull(autor3.username);
    var value_3 = ArrayList_init();
    $receiver_11.put_xwzc9p$(key_11, value_3);
  ...
  package$apis.isUserAdmin_61zpoe$ = isUserAdmin;
