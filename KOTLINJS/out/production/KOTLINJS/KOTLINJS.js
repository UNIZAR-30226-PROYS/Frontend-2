...
var KOTLINJS = function (_, Kotlin) {
  ...
  function main(args) {
    var user = obtainUserDataServer('abelcht', 'fdf');
    ensureNotNull(document.getElementById('prueba')).innerHTML = 'pru';
  }
  ...
  var package$spreadyourmusic = package$com.spreadyourmusic || (package$com.spreadyourmusic = {});
  var package$spreadyourmusic_0 = package$spreadyourmusic.spreadyourmusic || (package$spreadyourmusic.spreadyourmusic = {});
  var package$apis = package$spreadyourmusic_0.apis || (package$spreadyourmusic_0.apis = {});
  package$apis.isServerOnline = isServerOnline;
  package$apis.doLoginServer_puj7f4$ = doLoginServer;
  package$apis.doSignUpServer_v23pek$ = doSignUpServer;
  ...
  package$apis.uploadSongServer_7cdp5e$ = uploadSongServer;
  ...
  package$apis.createPlaylistServer_ajw8nj$ = createPlaylistServer;
  package$apis.deletePlaylistServer_ajw8nj$ = deletePlaylistServer;
  package$apis.updatePlaylistServer_ajw8nj$ = updatePlaylistServer;
  ...
  package$apis.createAlbumsServer_eai1le$ = createAlbumsServer;
  package$apis.updateAlbumsServer_eai1le$ = updateAlbumsServer;
  package$apis.deleteAlbumsServer_eai1le$ = deleteAlbumsServer;
  var package$controller = package$spreadyourmusic_0.controller || (package$spreadyourmusic_0.controller = {});
  package$controller.main_kand9s$ = main;
  var package$models = package$spreadyourmusic_0.models || (package$spreadyourmusic_0.models = {});
  ...
  var package$test = package$spreadyourmusic_0.test || (package$spreadyourmusic_0.test = {});
